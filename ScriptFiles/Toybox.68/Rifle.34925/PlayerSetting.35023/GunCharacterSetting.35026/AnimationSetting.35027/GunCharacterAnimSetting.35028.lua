------------------------------------------------------------------------------------------------------------
--캐릭터에 총기 애니메이션을 설정하는 스크립트에요.
------------------------------------------------------------------------------------------------------------

local Object = Script.Parent --Script의 부모 오브젝트(AnimationSetting)를 Object 변수에 할당해요.
local IdleName = Object.Idle
local AnimStateMachineSetting = Game:AddAnimStateMachineSetting("GunCharacterAnim") --캐릭터에 사용될 애니메이션 상태머신 설정을 추가해요.
...
--Stand
local AnimState = AnimStateMachineSetting:AddAnimState("Stand", Object.FPS_Stand, InfinityPlay) 

--Idle
AnimState = AnimStateMachineSetting:AddAnimState("Idle", Object.FPS_Stand, 1) 
...
--Walk
AnimState:AddBlendAnimation(0.0, Object.FPS_Walk, 0.6)
AnimState:AddBlendAnimation(150.0, Object.FPS_Walk)
...
--JumpStart
AnimState = AnimStateMachineSetting:AddAnimState("JumpStart", Object.FPS_Jump)

--JumpLoop
AnimState = AnimStateMachineSetting:AddAnimState("JumpLoop", Object.FPS_Fall, InfinityPlay)

--JumpEnd
AnimState = AnimStateMachineSetting:AddAnimState("JumpEnd", Object.FPS_Land)
