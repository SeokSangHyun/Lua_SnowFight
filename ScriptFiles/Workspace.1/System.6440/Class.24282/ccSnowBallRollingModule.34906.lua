...
cc_SnowBallRolling = {}
cc_SnowBallRolling.__index = cc_SnowBallRolling

--!---------------------------- 초기화 ------------------------------
--# 목적 : 생성시 정보 초기화
function cc_SnowBallRolling.new(object)
    local t = setmetatable({}, cc_SnowBallRolling)
...
--!---------------------------- Getter/Setter ------------------------------
--# 목적 : 아이템 획득
function cc_SnowBallRolling:GetBulletCount()
    return 
end
...
--!---------------------------- 발사 로직 ------------------------------
--# 시작 전 세팅
function cc_SnowBallRolling:Rolling()
end
...
--!---------------------------- 발사 로직 ------------------------------
--# 아이템 발사 전 처리
function cc_SnowBallRolling:PreFireObject(playerID, forX, forY, forZ)
...
--!---------------------------- 데미지 로직 ------------------------------
function cc_SnowBallRolling:GetDamage(); return self.Damage; end;



return cc_SnowBallRolling;
